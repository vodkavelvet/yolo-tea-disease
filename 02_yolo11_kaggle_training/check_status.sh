#!/bin/bash
# Check Kaggle Kernel Status dan Download Output
# Usage:
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "  YOLO11 Training Status & Download Checker"
echo "═══════════════════════════════════════════════════════════════"
echo ""

# Check Status
cmd_status() {
    echo "📊 Cek Status Training..."
    echo ""
...
# Download Results
cmd_download() {
    echo "📥 Download Output dari Kaggle..."
    echo ""
...
case "${1:-status}" in
    ...
    *)
        echo "Usage:"
        echo "  sh check_status.sh status   # Cek status training"
